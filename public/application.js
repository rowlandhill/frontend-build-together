...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://mysterious-thicket-17727.herokuapp.com/',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onCreateProject = function onCreateProject(event) {
	  ...
	  api.createProject(data).then(ui.createProjectSuccess)
	...
	var onCreateTask = function onCreateTask(event) {
	  ...
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.createTask(data).then(ui.createTaskSuccess).catch(ui.createTaskFailure);
	};

	var onGetAllProjects = function onGetAllProjects(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.getAllProjects(data).then(ui.getAllProjectsSuccess).catch(ui.getAllProjectsFailure);
	};

	var onGetAllTasks = function onGetAllTasks(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.getAllTasks(data).then(ui.getAllTasksSuccess).catch(ui.getAllTasksFailure);
	};
	...
	var appendCreateTask = function appendCreateTask(event) {
	  event.preventDefault();
	...
	var showCreateProject = function showCreateProject(event) {
	  event.preventDefault();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var updateTask = function updateTask(data, newTask) {
	  // console.log(data + 'PATCH TEST DATA')
	  event.preventDefault();
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showOneProjectTemplate = __webpack_require__(32);
	var showNewProjectTemplate = __webpack_require__(33);
	...
	var onUpdateProject = function onUpdateProject(event) {
	  ...
	  refreshProjects();
	  api.updateProject(data, newProject).then(updateProjectSuccess).catch(updateProjectFailure);
	};

	var onUpdateTask = function onUpdateTask(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  var newTask = $(event.target).attr('data-id');
	  console.log('event.target is ' + data);
	  console.log('newProject is ', newTask);
	  $('.updateProject').trigger('reset');
	  refreshProjects();
	  api.updateTask(data, newTask).then(updateProjectSuccess).catch(updateTaskFailure);
	};

	var refreshProjects = function refreshProjects(data) {
	  var showProjectHtml = showProjectsTemplate({ projects: store.projectList });
	  $('.getAllProjectsContent').empty();
	...
	var createProjectSuccess = function createProjectSuccess(data) {
	  ...
	  $('#create-project-body').addClass('hidden');
	  var showNewProjectHtml = showNewProjectTemplate({ project: store.singleProject });
	...
	var getAllProjectsSuccess = function getAllProjectsSuccess(data) {
	...
	var getAllProjectsFailure = function getAllProjectsFailure(error) {
	...
	var createTaskFailure = function createTaskFailure(error) {
	...
	var getAllTasksFailure = function getAllTasksFailure(error) {
	...
	var getProjectSuccess = function getProjectSuccess(data) {
	  ...
	  var showOneProjectHtml = showOneProjectTemplate({ project: store.singleProject });
	  $('#getAllProjectsContent').empty();
	  $('#getNewProjectContent').empty();
	...
	var updateProjectSuccess = function updateProjectSuccess(response) {
	  ...
	  api.getProject(response).then(getProjectSuccess).catch(getProjectFailure);
	};
	...
	var updateTaskFailure = function updateTaskFailure(error) {
	  console.log(error);
	};

	var onGetSingleProject = function onGetSingleProject(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  console.log('onGetProject data is ', data);
	  console.log('data.project.id is ', data.project.id);
	  api.getProject(data).then(getProjectSuccess).catch(getProjectFailure);
	};
	...
	var onDeleteProject = function onDeleteProject(event) {
	  ...
	  // })
	  // refreshProjects()
	  api.deleteProject(removeProject).then(deleteProjectSuccess).catch(deleteProjectFailure);
	  // .then(() => {
	  //   api.getAllProjects()
	...
	var onDeleteTask = function onDeleteTask(event) {
	  ...
	  var removeTask = $(event.target).attr('data-id');
	  // store.projectList = store.projectList.filter((project) => {
	  //   return String(project.id) !== String(removeProject)
	  // })
	  // refreshProjects()
	  api.deleteTask(removeTask).then(deleteTaskSuccess).catch(deleteTaskFailure);
	  // .then(() => {
	  //   api.getAllProjects()
	  //     .then(getAllProjectsSuccess)
	  //     .catch(getAllProjectsFailure)
	...
	var deleteProjectSuccess = function deleteProjectSuccess(response) {
	  ...
	  api.getAllProjects().then(getAllProjectsSuccess).catch(getAllProjectsFailure);
	};
	...
	var deleteTaskSuccess = function deleteTaskSuccess(response) {
	  console.log('deleteTaskSuccess response is ', response);
	};

	var deleteTaskFailure = function deleteTaskFailure(error) {
	  console.log(error);
	};
	...
	module.exports = {
	  ...
	  getAllProjectsSuccess: getAllProjectsSuccess,
	  getAllProjectsFailure: getAllProjectsFailure,
	  getAllTasksSuccess: getAllTasksSuccess,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<form id=\"seeMore\" class=\"form-group seeMore\" id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n  <div style=\"background-color:white; border-radius:5px; padding:5px;\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"project-post col-md-8\">\n    <button type=\"submit\" class=\"btn btn-default\" id=\"get-project\">edit "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "</button>\n    <ul style=\"list-style-type: none;\">\n      <li><h4><strong>Project: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "</strong></h4></li>\n\n      <li class=\"desc\"><strong>Project Description:</strong> "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.body : stack1), depth0))
	    + "</li>\n  </ul>\n  <br>\n  <!-- <form id=\"seeMore\" class=\"form-group seeMore\" id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"> -->\n    <div class=\"form-group\">\n      <input class=\"form-control hidden\" type=\"text\" name=\"project[id]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n    </div>\n  <!-- <button type=\"submit\" class=\"btn btn-default\" id=\"get-project\">edit this project</button> -->\n  </form>\n </div>\n <div style=\"background-color:white; border-radius:5px; padding:5px;\" class=\"tasks col-md-8\">\n   <ul>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.tasks : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "    </ul>\n  </div>\n<br>\n\n\n";
	},"2":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

	  return "     <li><h5><strong>Task: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "</strong></h5></li>\n     <li class=\"desc\"><strong>Task Description:</strong> "
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "   <div style=\"background-color:white; border-radius:5px; padding:5px;\" class=\"tasks col-md-12\">\n     <ul>\n       <li><h5><strong>Task: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "</strong></h5></li>\n       <li class=\"desc\"><strong>Task Description:</strong> "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
	    + "</li>\n       <li class=\"iscomplete\"><strong>Finished? :</strong> "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.iscomplete : stack1), depth0))
	    + "</li>\n      </ul>\n      <form id=\"updateTasks\" class=\"updateTasks\" id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n\n       <div class=\"container-fluid\">\n         <br>\n          <input class=\"form-control handlebars-update\" type=\"text\" name=\"task[name]\" id=\"handlebars-task-name\" placeholder=\"update task name\">\n          <br>\n          <div class=\"form-group\">\n        <textarea class=\"form-control handlebars-update\" name=\"task[description]\" id=\"handlebars-task-desc\" rows=\"7\" placeholder=\"update description here\"></textarea>\n       </div>\n       <div class=\"form-group\">\n           <input type=\"radio\" name=\"task[iscomplete]\" value=\"true\"> Complete<br>\n         </div>\n       <input data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"submit\" class=\"btn btn-default\" value=\"update\">\n       <br>\n       <div class=\"destroyTask\">\n         <br>\n          <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" id=\"red-button\" class=\"btn btn-danger\" value=\"delete\">task completed</button>\n        </div>\n       </form>\n    </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

	  return "<div style=\"background-color:white; border-radius:5px; padding:5px;\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.project : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"col-md-12\">\n    <ul style=\"list-style-type: none;\">\n      <li><h4>Project:<strong> "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.project : depth0)) != null ? stack1.title : stack1), depth0))
	    + "</strong></h4></li>\n      <li class=\"desc\"><p><strong>Project Description:</strong> "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.project : depth0)) != null ? stack1.body : stack1), depth0))
	    + "</p></li>\n    </ul>\n   </div>\n   <br>\n   <br>\n   <br>\n   <form id=\"updateProject\" class=\"updateProject\" id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.project : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.project : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n     <br>\n     <br>\n    <div class=\"container-fluid\">\n      <br>\n       <input class=\"form-control handlebars-update\" type=\"text\" name=\"project[title]\" id=\"handlebars-project-title\" placeholder=\"update project name\">\n       <br>\n       <div class=\"form-group\">\n     <textarea class=\"form-control handlebars-update\" name=\"project[body]\" id=\"handlebars-project-body\" rows=\"7\" placeholder=\"update description here\"></textarea>\n    </div>\n    <input data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.project : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"submit\" class=\"btn btn-default\" value=\"update\">\n    <br>\n    <div class=\"destroyProject\">\n      <br>\n       <button data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.project : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" id=\"red-button\" class=\"btn btn-danger\" value=\"delete\">delete project</button>\n     </div>\n    </form>\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = (depth0 != null ? depth0.project : depth0)) != null ? stack1.tasks : stack1),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div style=\"background-color:white; opacity:0.8; border-radius:5px; padding:5px;\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.project : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"col-md-6\">\n    <ul style=\"list-style-type: none;\">\n      <li><h4>Project:<strong> "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.project : depth0)) != null ? stack1.title : stack1), depth0))
	    + "</strong></h4></li>\n      <li class=\"desc\"><p><strong>Project Description:</strong> "
